...
$query = "SELECT * FROM ventas WHERE sucursal_id='$sucursal_id'";
...
<body class="bg-gray-100">
    <div class="container mx-auto mt-10">
        <h1 class="text-3xl font-bold text-center mb-5">Ventas - Sucursal: <?php echo $sucursal_id; ?></h1>
            ...
            <table class="min-w-full bg-white">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="py-2"><?php echo $row['precio']; ?></td>
